...
`optimize-resume` 是一个面向 Codex 的简历优化 Skill。它从抖音知名求职博主“冤种小徐”的写简历教学视频文案中提炼核心方法，并由 AI 延展成可复用的简历优化工作流。
...
`optimize-resume` is a Codex skill for resume optimization. It distills the core method from the resume-writing tutorial transcript of the well-known Douyin job-search creator "冤种小徐", then extends it with AI into a reusable resume optimization workflow.
